...
class DatabaseHandler(context: Context):
    ...
    companion object {
        ...
        private val DATABASE_VERSION = 1 //Kita tuliskan versi Database yang akan digunakan

        private val DATABASE_NAME = "EmployeeDatabaseKuis" // Kita tentukan nama database yang akan digunakan, usahakan namanya yang mudah saja yaa..

        //Disini kita akan membuat table yang ada di databasenya sesuai dengan kebutuhan aplikasi yang kita pakai
        ...
        //Karena saya disini menggunakan fitur login, maka kita tuliskan komponen table login yang kita butuhkan saat melakukan proses login
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        ...
        //Dalam pembuatan table, kita harus definisikan fungsi-fungsi di dalamnya, contohnya : integer
